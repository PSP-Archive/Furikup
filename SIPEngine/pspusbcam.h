...
/**
 * Init USB mic (e.g. Talkman)
 */
int sceUsbMicInputInit(int arg1, int arg2, int arg3);

/**
 * Read from usb mic
 */
int sceUsbMicInputBlocking(unsigned long numsamples, unsigned long freq, unsigned short * buffer);
