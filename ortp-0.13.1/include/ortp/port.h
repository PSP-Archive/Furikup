...
typedef int ortp_socket_t;
#define ortp_mutex_t int
#define ortp_thread_t int
#define ortp_cond_t int

#define ortp_thread_create	psp_thread_create
#define ortp_thread_join	psp_thread_join
#define ortp_thread_exit	psp_thread_exit		
#define ortp_mutex_init		psp_mutex_init
#define ortp_mutex_lock		psp_mutex_lock
#define ortp_mutex_unlock	psp_mutex_unlock
#define ortp_mutex_destroy	psp_mutex_destroy
#define ortp_cond_init		psp_cond_init
#define ortp_cond_signal	psp_cond_signal
#define ortp_cond_broadcast	psp_cond_broadcast
#define ortp_cond_wait		psp_cond_wait
#define ortp_cond_destroy	psp_cond_destroy
...
int psp_cond_init(ortp_cond_t *cond, void *attr_unused);
int psp_cond_wait(ortp_cond_t * cond, ortp_mutex_t * mutex);
